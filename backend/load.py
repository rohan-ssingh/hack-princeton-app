...
class Storage:
    ...
    def rag(self, question: str, schema: Optional[BaseModel] = None, date_range: Optional[tuple[date | None, date | None]] = (None, None)):
        ...
        Args:
            ...
            date_range (Optional[tuple[date | None, date | None]]): A tuple containing the start and end date for filtering documents, in (start_date, end_date) format.
        Returns:
            The response generated by the LLM based on the retrieved documents.
        """

        retrieved_docs = self.vector_store.similarity_search(question, k=50)
